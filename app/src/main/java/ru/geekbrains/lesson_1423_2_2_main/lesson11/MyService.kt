package ru.geekbrains.lesson_1423_2_2_main.lesson11
...
import ru.geekbrains.lesson_1423_2_2_main.view.MainActivityWebView
...
class MyService : FirebaseMessagingService() {
    ...
    private fun pushNotification(title: String, message: String) {
        ...
        val notificationBuilder_1 = NotificationCompat.Builder(this, CHANNEL_ID_1).apply {
            ...
            addAction(R.drawable.ic_map_marker, "Open app", intent)
